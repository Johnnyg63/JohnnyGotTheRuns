...
set EMSDK="C:\pge_ems\emsdk\"

:: Location of olc::PixelGameEngine header file
set OLCPGE="D:\pge_ems\PGE_Released\"
...
echo %CPP%
	if exist ".\assets" (
		...
		call em++ -std=c++17 -O2 -s FORCE_FILESYSTEM=1 -s ALLOW_MEMORY_GROWTH=1 -s MAX_WEBGL_VERSION=2 -s MIN_WEBGL_VERSION=2 -s USE_FREETYPE=1 -s USE_LIBPNG=1 --preload-file .\assets\images\@./assets/images/ %CPP% -o .\WASM\pge.html -I %OLCPGE%
	) else (
